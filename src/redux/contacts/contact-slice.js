...
import {fetchContacts, addContactsFetch, deleteContacts} from './contact-operations'
...
const contactsSlice = createSlice({
    ...
    extraReducers: {
        ...
        [addContactsFetch.pending]: (store) => ({ ...store, loading: true, error: null }),
        [addContactsFetch.fulfilled]: (store, { payload }) => {
            store.items.push(payload);
            store.loading = false;
        },
        [addContactsFetch.rejected]: (store, { payload }) => ({ ...store, loading: false, error: payload }),
        ...
        [deleteContacts.rejected]: (store, { payload }) => ({ ...store, loading: false, error: payload }),
    }
})
